...
class SRModel(BaseModel):
    ...
    def test_selfensemble(self):
        ...
        if hasattr(self, 'net_g_ema'):
            ...
            self.net_g.eval()
            with torch.no_grad():
                out_list = [self.forward_chop(aug) for aug in lq_list]
            self.net_g.train()
    ...
    def forward_chop(self, x, part=2, shave=80, min_size=160000):
        n_GPUs = 1
        b, c, h, w = x.size()
        h_half, w_half = h // part, w // part
